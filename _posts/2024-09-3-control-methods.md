...
A summary of the different control methods (control strategies) is shown in the following figure. It is worth noting that there are various combinations of these control methods found in the literature. (Download pdf file of the chart from [here](assets/pdf/Control Methods.pdf).)
